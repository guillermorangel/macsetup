...
# wget -O ~/Downloads/EU-Installset-M3.14.10.7.dmg.zip "https://pdisp01.c-wss.com/gdl/WWUFORedirectTarget.do?id=MDIwMDAwNjQ4MDAx&cmp=ABR&lang=EN"
# unzip ~/Downloads/EU-Installset-M3.14.10.7.dmg.zip -d ~/Downloads/
# hdiutil attach ~/Downloads/EU-Installset-M3.14.10.7.dmg
# open /Volumes/EU3.14.10/eum3.14.10-installer.app
# echo "Enter, to cleanup ..."
# read
# hdiutil detach /Volumes/EU3.14.10
